...
$\Downarrow$ & & & $\searrow$ & \\
\hline
\multicolumn{5}{c}{\textcolor{agrogris}{\textbf{Dashboard Streamlit}} \quad http://localhost:8501} \\
\hline
\end{tabular}
...
\begin{alertbox}[Nota importante — AWS Academy]
Las credenciales de AWS Academy expiran cada 4 horas. Renovar antes de
ejecutar los scripts AWS (05, 06) y antes de abrir el notebook en EMR.
El tiempo de vida del clúster EMR es de máximo 3 horas en la sesión
de laboratorio.
\end{alertbox}
